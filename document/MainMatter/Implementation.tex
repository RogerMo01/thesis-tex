...
adaptabilidad de la interfaz, asegurando que el sitio fuese completamente responsivo y brindara una experiencia 
...
En cuanto a la base de datos, se realizó una población inicial utilizando la información extraída del 
...
La ventaja de utilizar trigramas es que se puede calcular la similitud entre el término de búsqueda y las palabras de la base de datos de manera rápida y eficaz. En nuestro caso, utilizamos el cálculo del 
\textbf{coeficiente de similitud} entre trigramas para determinar que términos en la base de datos 
...
En PostgreSQL, este enfoque se implementa mediante la extensión \texttt{pg\_trgm} y la función \texttt{similarity}, que calcula la similitud entre dos cadenas de texto basándose en la cantidad de trigramas en común. 
Esta función es parte de la extensión \texttt{pg\_trgm} y se utiliza para comparar cada término de búsqueda con los registros en la base de datos. Cuanto mayor sea el número de trigramas en común, mayor será la similitud entre las dos cadenas.
